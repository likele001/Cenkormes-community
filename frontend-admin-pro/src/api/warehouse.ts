...
export type WarehouseEntryItemOut = {
  id: number
  material_id: number
...
export type WarehouseEntryOut = {
  ...
  remark: string | null
  created_at: string
  items: WarehouseEntryItemOut[]
}

export type EntryItemIn = {
  material_id: number
  sku_id: number
  qty: number
}
...
export const warehouseApi = {
  ...
  listIssues(params: { warehouse_id?: number; work_order_id?: number; status?: string; offset?: number; limit?: number }) {
    const p: any = { warehouse_id: params.warehouse_id, work_order_id: params.work_order_id, status: params.status, offset: params.offset, limit: params.limit }
  ...
  listEntries(params: { warehouse_id?: number; source_type?: string; status?: string; offset?: number; limit?: number }) {
    const p: any = { warehouse_id: params.warehouse_id, source_type: params.source_type, status: params.status, offset: params.offset, limit: params.limit }
